...
"
    ...
    Private Sub InsertNewOwnerRecord()
        ...
        Dim FieldsData =
                                InQuotes(LastNameTextBox.Text) & ", " &
                                InQuotes(FirstNameTextBox.Text) & ", " &
                                InQuotes(NamePrefixTextBox.Text) & ", " &
                                InQuotes(AliasTextBox.Text) & ", " &
                                InQuotes(PhoneNumber) & ", " &
                                InQuotes(EmailAddressTextBox.Text) & ", " &
                                InQuotes(StreetTextBox.Text) & ", " &
                                InQuotes(BldgAptRmNoTextBox.Text) & ", " &
    ...
    Private Function OwnerFieldsEntriesAreNotValidAndComplete()
        ...
        Else
            ...
            Else
                ...
                '                Return True
                '            End If
                MySelection = " Select * from OwnersTable Where TelNo_ShortText10 = " & InQuotes(PhoneNumber)
                JustExecuteMySelection()
            ...
            End If
        End If
        If MaxLengthOfFieldExceeded(LastNameTextBox, 30) Then Return True
        If MaxLengthOfFieldExceeded(FirstNameTextBox, 30) Then Return True
