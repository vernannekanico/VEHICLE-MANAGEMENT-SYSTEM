Public Class ProductsPartsForm
    ...
    Private Sub SetToStocksViewMode()
        ...
        If Not SavedCallingForm.Name = "StoreRequisitionsForm" Then SelectToolStripMenuItem.Visible = False
...
FROM ((StocksTable RIGHT JOIN ((((((ProductsPartsTable 
...
"
    ...
    Private Sub SelectToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SelectToolStripMenuItem.Click
        ...
        Select Case SavedCallingForm.Name
            ...
            Case "StoreRequisitionsForm"
                StoreRequisitionsForm.PartTextBox.Text = ProductsPartsDataGridView.Item("ManufacturerPartNo_ShortText30Fld", CurrentProductsPartsRow).Value
                StoreRequisitionsForm.RequisitionItemProductDescTextBox.Text = ProductsPartsDataGridView.Item("ManufacturerDescription_ShortText250", CurrentProductsPartsRow).Value
                StoreRequisitionsForm.RequisitionItemUnitTextBox.Text = ProductsPartsDataGridView.Item("Unit_ShortText3", CurrentProductsPartsRow).Value
                StoreRequisitionsForm.PackingTextBox.Text = PackingTextBox.Text
        End Select
    ...
    Private Sub DeleteToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DeleteToolStripMenuItem.Click
        ...
        Dim TablesToCheck = New Char() {
                                        ...
                                        "WorkOrderRelationsTable",
                                        "DeliveryItemsTable"
                                        }
        If Not LinkExistsIn(TablesToCheck) Then
