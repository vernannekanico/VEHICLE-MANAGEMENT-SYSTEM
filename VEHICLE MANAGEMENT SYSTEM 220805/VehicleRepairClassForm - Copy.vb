Public Class VehicleRepairClassForm
    ...
    Private Sub VehicleRepairClassForm_Load(sender As Object, e As EventArgs) Handles Me.Load
        ' form returns       Tunnel1 = CurrentVehicleRepairClassID
        '                    Tunnel2 = ?

        ' form sends         ?
        '                    ?

        ' form recieves on enabled  ' from VehicleDetailsDtetailsForm : CurrentVehicleTypeID and CurrentVehicleModelID
        ...
        If NotEmpty(Tunnel1) Then                   ' maybe set a selected TypeOfVehicle by VehicleTypeForm
            '        ThereIsARecord  a need to pass the type And model number to filter selection here caller has to provide if caller i requesting a code

            CurrentVehicleTypeID = Tunnel1
            CurrentVehicleModelID = Tunnel2
            CurrentVehicleModelsRelationsID = Tunnel3
            VehicleRepairClassSelectionFilter = "  WHERE VehicleModelsRelationsID_LongInteger = " & Str(CurrentVehicleModelsRelationsID)
        End If
    ...
    Private Sub FillVehicleRepairClassDataGridView()
        ...
        VehicleRepairClassFieldsToSelect = "SELECT VehicleTypeTable.VehicleType_ShortText20, " &
                                           ...
                                           " VehicleRepairClassTable.VehicleModelsRelationsID_LongInteger, " &
        ...
        VehicleRepairClassTablesLinks = " FROM VehicleRepairClassTable " &
                                               ...
                                               " LEFT JOIN VehicleModelsTable ON VehicleModelsRelationsTable.[VehicleModelID_LongInteger] = VehicleModelsTable.VehicleModelID_Autonumber)" &
                                                                            " ON VehicleRepairClassTable.[VehicleModelsRelationsID_LongInteger] = VehicleModelsRelationsTable.VehicleModelsRelationsID_Autonumber "
    ...
    Private Sub SetupVehicleRepairClassDataGridView()
        ...
        VehicleRepairClassDataGridView.Columns.Item("VehicleModelsRelationsID_LongInteger").Visible = False
    ...
    Private Sub VehicleModelDataGridView_DataBindingComplete(sender As Object, e As DataGridViewBindingCompleteEventArgs) Handles VehicleRepairClassDataGridView.DataBindingComplete
        ...
        '       VehicleModelDataGridView.Location = New Point(1, 49)
    End Sub
    ...
    Private Sub ShowVehicleRepairClassDetailsGroupBox()
        ...
        If CurrentVehicleRepairClassID = -1 Then                                                        ' no record selected
            YearManufacturedFromTextBox.Text = VehicleDetailsForm.YearManufacturedTextBox.Text
            YearManufacturedToTextBox.Text = VehicleDetailsForm.YearManufacturedTextBox.Text
    ...
    Private Sub FillVehicleRepairClassDetailsForm()
        If Not IsDBNull(VehicleRepairClassDataGridView.Item("YearManufacturedFrom", CurrentVehicleRepairClassRow).Value) Then
            VehicleModelsRelationsDetailsForm.VehicleTypeTextBox.Text = VehicleRepairClassDataGridView.Item("YearManufacturedFrom", CurrentVehicleRepairClassRow).Value
        End If
        If Not IsDBNull(VehicleRepairClassDataGridView.Item("YearManufacturedTo", CurrentVehicleRepairClassRow).Value) Then
            VehicleModelsRelationsDetailsForm.VehicleModelTextBox.Text = VehicleRepairClassDataGridView.Item("YearManufacturedTo", CurrentVehicleRepairClassRow).Value
        End If
    End Sub
    Private Sub SelectToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SelectToolStripMenuItem.Click

        Tunnel1 = CurrentVehicleRepairClassID

        VehicleDetailsForm.YearManufacturedFromTextBox.Text = VehicleRepairClassDataGridView.Item("YearManufacturedFrom_ShortText4", CurrentVehicleRepairClassRow).Value
        VehicleDetailsForm.YearManufacturedToTextBox.Text = VehicleRepairClassDataGridView.Item("YearManufacturedTo_ShortText4", CurrentVehicleRepairClassRow).Value
        Me.Close()
    End Sub
    Private Sub CancelToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CancelToolStripMenuItem.Click
        ...
        End Select
    End Sub
    Private Sub VehicleRepaiModeForm_Closed(sender As Object, e As EventArgs) Handles Me.Closed
    ...
    Private Sub VehicleModelsRelationsForm_EnabledChanged(sender As Object, e As EventArgs) Handles Me.EnabledChanged
        ...
        ' GET RETURNED DATA HERE not sue if needed if coming from update

        ' form recieves or enabled  ' CurrentVehicleTypeID or CurrentVehicleModelID If IsEmpty(Tunnel1) Then Exit Sub
        '                           ' Tunnel2 - 2 '    Add, 3 ' change trim,  4 ' change type

        If (Tunnel1) = Nothing Then Exit Sub        ' CurrentVehicleTypeID Or CurrentVehicleModelID 
        Select Case Tunnel2 ' set by called for 2 type etc
            Case 1                                  ' Add
                CurrentVehicleTypeID = Tunnel1
            Case 2                                 ' Change Trim
    ...
    Private Sub YearManufacturedFromTextBox_TextChanged(sender As Object, e As EventArgs) Handles YearManufacturedFromTextBox.TextChanged
        If Not YearManufacturedFromTextBox.Text = "year should not be earlier than Vehicle year manufactured" Then
            If Not YearManufacturedFromTextBox.Text = "" Then
                If YearManufacturedFromTextBox.Text > VehicleDetailsForm.YearManufacturedTextBox.Text Then
    ...
    Private Sub SaveVehicleRepairClassFieldContents()
        Select Case PurposeOfVehicleRepairClassDetailsGroupBoxEntry
            Case "ADD"
                ...
                Dim VehicleRepairClass = Trim(VehicleDetailsForm.VehicleTypeTextBox.Text) & " " &
                                         Trim(VehicleDetailsForm.VehicleModelTextBox.Text) & " From " &
                ...
                If Not SuccessfullyAddingThisVehicleRepairClassRecord() Then
                    MsgBox("Vehicle CLASS already exist ")
                    Exit Sub
                End If
            Case "EDIT"
                Dim VehicleRepairClass = Trim(VehicleDetailsForm.VehicleTypeTextBox.Text) & " " &
    ...
    Private Function ThisVehicleRepairClassAlreadyExist()
        ...
        MySelection = VehicleRepairClassFieldsToSelect & VehicleRepairClassTablesLinks & CombinedFilter & VehicleRepairClassSelectionOrder
    ...
    Private Function SuccessfullyAddingThisVehicleRepairClassRecord()
        ...
        Dim VehicleRepairClassTablesFilter = " WHERE  YearManufacturedFrom_ShortText4 = " & Chr(34) & Trim(YearManufacturedFromTextBox.Text) & Chr(34) &
                                                ...
                                                " AND VehicleModelsRelationsID_LongInteger = " & Str(CurrentVehicleModelsRelationsID)
