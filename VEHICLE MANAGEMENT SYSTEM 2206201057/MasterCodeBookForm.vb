...
Public Class MasterCodeBookForm
    ...
    Private Sub MasterCodeBookForm_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        Select Case SavedCallingForm.Name
            Case "ConcernsForm"
                SelectSystemInfoHeadersToolStripMenuItem.Visible = False
                InformationsToolStripLabel.Visible = False
                AddSystemInfoHeadersToolStripMenuItem.Visible = False
                RemoveSystemInfoHeaderToolStripMenuItem.Visible = False
                HeaderDetailsToolStripLabel.Visible = False
            ...
            Case "WorkOrderFormASS"
                CurrentVehicleRepairClassID = Tunnel3
                SearchMasterCodeBookTextBox.Text = ConcernsForm.SearchConcernTextBox.Text
    ...
    Private Sub FillSystemInfoHeadersDataGridView()
        SystemInfoHeadersFieldsToSelect = " 
Select SystemInfoHeadersTable.SystemInfoHeaderID_AutoNumber,
FileReferencesTable.FileName_ShortText255,
SystemInfoHeadersTable.MasterCodeBookId_LongInteger,
SystemInfoHeadersTable.InformationsHeaderID_LongInteger,
SystemInfoHeadersTable.FileReferenceID_LongInteger,
...
FROM((SystemInfoHeadersTable LEFT JOIN MasterCodeBookTable On SystemInfoHeadersTable.MasterCodeBookId_LongInteger = MasterCodeBookTable.MasterCodeBookID_Autonumber)
LEFT JOIN InformationsHeadersTable On SystemInfoHeadersTable.[InformationsHeaderID_LongInteger] = InformationsHeadersTable.[InformationsHeaderID_AutoNumber])
Left JOIN FileReferencesTable On SystemInfoHeadersTable.FileReferenceID_LongInteger = FileReferencesTable.FileReferenceID_AutoNumber 
"
        SystemInfoHeadersFieldsToSelect = " 
SELECT 
SystemInfoHeadersTable.SystemInfoHeaderID_AutoNumber,
MasterCodeBookTable.MasterCodeBookID_Autonumber, 
MasterCodeBookTable.SubSystemCode_ShortText24Fld, 
InformationsHeadersTable.InformationsHeaderDescription_ShortText255, 
InformationsHeadersTable.InformationsHeaderID_AutoNumber
FROM (SystemInfoHeadersTable LEFT JOIN InformationsHeadersTable ON SystemInfoHeadersTable.InformationsHeaderID_LongInteger = InformationsHeadersTable.InformationsHeaderID_AutoNumber) LEFT JOIN MasterCodeBookTable ON SystemInfoHeadersTable.MasterCodeBookId_LongInteger = MasterCodeBookTable.MasterCodeBookID_Autonumber
"
        'FILTERS ALL INFORMATIONS ABOUT CURRENT MasterCodeBookID
        SystemInfoHeadersSelectionFilter = " WHERE MasterCodeBookID_Autonumber = " & CurrentMasterCodeBookSubSystemID
        SystemInfoHeadersSelectionOrder = " ORDER BY SubSystemCode_ShortText24Fld "

        MySelection = SystemInfoHeadersFieldsToSelect & SystemInfoHeadersSelectionFilter & SystemInfoHeadersSelectionOrder

        JustExecuteMySelection()

        SystemInfoHeadersRecordCount = RecordCount
        If SystemInfoHeadersRecordCount = 0 Then
            AddSystemInfoHeadersToolStripMenuItem.Visible = True
            CreateInfoPerVehicleDetailsToolStripMenuItem.Visible = False
    ...
    Private Sub FormatInformationsHeadersCodeBookDataGridView()
        ...
        For i = 0 To SystemInfoHeadersDataGridView.Columns.GetColumnCount(0) - 1
            ...
            SystemInfoHeadersDataGridView.Columns.Item(i).Visible = False
            Select Case SystemInfoHeadersDataGridView.Columns.Item(i).Name
                Case "InformationsHeaderDescription_ShortText255"
                    SystemInfoHeadersDataGridView.Columns.Item(i).HeaderText = "ACTION"
                    SystemInfoHeadersDataGridView.Columns.Item(i).Width = 100 * 184 / 15
                    SystemInfoHeadersDataGridView.Columns.Item(i).Visible = True
            End Select
    ...
    Private Sub SystemInfoHeadersTableDataGridView_RowEnter(sender As Object, e As DataGridViewCellEventArgs) Handles SystemInfoHeadersDataGridView.RowEnter
        ...
        CurrentSystemInfoHeaderID = SystemInfoHeadersDataGridView("SystemInfoHeaderID_AutoNumber", CurrentSystemInfoHeaderRow).Value
        CurrentInformationHeaderID = SystemInfoHeadersDataGridView("InformationsHeaderID_AutoNumber", CurrentSystemInfoHeaderRow).Value
        If DefaultVehicleModelTextBox.Text = "Set Default Vehicle" Then
            MsgBox("Pls Set Default Vehicle first if you are setting the details for each info header")
            Exit Sub
        End If
        ...
        MySelection = " Select * FROM FileReferencesTable WHERE SystemInfoHeadersID_LongInteger = " & CurrentSystemInfoHeaderID &
    ...
    Private Sub MasterCodeBookForm_EnabledChanged(sender As Object, e As EventArgs) Handles Me.EnabledChanged
        ...
        Select Case Tunnel1
            ...
            Case "Tunnel2IsInformationsHeaderID"
                ...
                Dim SystemInfoHeadersSelectionFilter2 = " FileReferenceID_LongInteger = " & CurrentVehicleRepairClassID.ToString
                Dim SystemInfoHeadersSelectionFilter3 = " InformationsHeaderID_LongInteger = " & Tunnel2.ToString
                ...
                If RecordCount = 0 Then
                    InsertANewSystemInfoHeaders(Tunnel2)
                End If
    ...
    End Sub
    Private Sub InsertANewFileReferencesTable()

        MySelection = " Select top 1 * FROM FileReferencesTable WHERE SystemInfoHeadersID_LongInteger = " & CurrentSystemInfoHeaderID.ToString &
        ...
        MySelection = "INSERT INTO FileReferencesTable  " & FieldsToUpdate & " VALUES " & ReplacementData
        ...
        MySelection = " UPDATE SystemInfoHeadersTable  Set FileReferenceID_LongInteger  = " & currentFileReferenceID.ToString
        JustExecuteMySelection()
    ...
    Private Sub InsertANewSystemInfoHeaders(InformationsHeaderID_LongInteger)
        ...
        CurrentSystemInfoHeaderID = InsertNewRecord("SystemInfoHeadersTable", FieldsToUpdate, FieldsData)
    ...
    Private Sub RemoveSystemInfoHeaderToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles RemoveSystemInfoHeaderToolStripMenuItem.Click
        ...
        If IsNotEmpty(SystemInfoHeadersDataGridView.Item("FileName_ShortText255", CurrentSystemInfoHeaderRow).Value) Then
            Exit Sub
        End If
        If MsgBox("Do you want to continue deleting this RECORD ?", vbYesNo) = vbYes Then
            MySelection = "DELETE FROM SystemInfoHeadersTable WHERE SystemInfoHeaderID_AutoNumber = " & Str(CurrentSystemInfoHeaderID)
            JustExecuteMySelection()
        End If
        FillSubSystemDataGridView()
    ...
    Private Sub SelectSystemInfoHeadersToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SelectSystemInfoHeadersToolStripMenuItem.Click
        Select Case CallingForm.Name

        'This returns the referenced Headers reference number
            Case = "ConcernsForm"
                Tunnel1 = SystemInfoHeadersDataGridView("InformationsHeaderID_LongInteger", CurrentSystemInfoHeaderRow).Value
                ConcernsForm.ConcernTextBox.Text = SystemInfoHeadersDataGridView("InformationsHeaderDescription_ShortText255", CurrentSystemInfoHeaderRow).Value
            Case = "VehicleManagementSystemForm"               '
            Case = "JobsForm"
                Tunnel1 = SystemInfoHeadersDataGridView("InformationsHeaderID_LongInteger", CurrentSystemInfoHeaderRow).Value
                JobsForm.JobTextBox.Text = SystemInfoHeadersDataGridView("InformationsHeaderDescription_ShortText255", CurrentSystemInfoHeaderRow).Value
            Case Else
    ...
    Private Sub ToolStripMenuItem2_Click(sender As Object, e As EventArgs) Handles CreateInfoPerVehicleDetailsToolStripMenuItem.Click
        If DefaultVehicleModelTextBox.Text = "Set Default Vehicle" Then
    ...
    Private Sub ToolStripMenuItem3_Click(sender As Object, e As EventArgs) Handles EditDetailsToolStripMenuItem.Click
        CreateOrReplace()
    End Sub
    Private Sub CreateOrReplace()
        ...
        r = RecordFinderDbControls.MyAccessDbDataTable.Rows(0)
        Dim xxInformationsHeadersTypePrefix = r("InformationsHeadersTypePrefix_ShortText50")
    ...
    Private Sub EnableSearch()
        ...
        MainSystemCodeDataGridView.Enabled = False
        SubSystemCodeDataGridView.Enabled = False
        SystemInfoHeadersDataGridView.Enabled = False
    ...
    Private Sub SearchButton_Click(sender As Object, e As EventArgs) Handles SearchButton.Click
        ...
        MainSystemCodeDataGridView.Enabled = True
        SubSystemCodeDataGridView.Enabled = True
        SystemInfoHeadersDataGridView.Enabled = True
