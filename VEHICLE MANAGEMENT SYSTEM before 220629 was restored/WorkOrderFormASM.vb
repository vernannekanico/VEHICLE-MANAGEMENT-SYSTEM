...
WorkOrderConcernsTable.AssignedServiceSpecialist_LongInteger, 
WorkOrderConcernsTable.ConcernID_LongInteger, 
InformationsHeadersTypeTable.JobPrefix50 & Space(1) & MasterCodeBookTable.SystemDesc_ShortText100Fld AS Job, 
MasterCodeBookTable.SystemDesc_ShortText100Fld, 
...
"
        ...
        JustExecuteMySelection()
        PartsToolStripMenuItem.Visible = False
...
Str(CurrentConcernJobStatusID)
    ...
    End Sub
    Private Sub ToolStripMenuItem8_Click(sender As Object, e As EventArgs) Handles PartsToolStripMenuItem.Click
