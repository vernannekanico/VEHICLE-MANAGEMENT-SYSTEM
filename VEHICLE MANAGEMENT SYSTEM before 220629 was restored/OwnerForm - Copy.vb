Public Class OwnerForm
    ...
    Private VehicleServicedFieldsToSelect = ""
    Private VehicleServicedTablesLinks = ""
    Private VehicleServicedSelectionFilter = ""
    Private VehicleServicedSelectionFilterSaved = ""
    Private VehicleServicedSelectionOrder = ""
    ...
    Private PassedThisWayYet As Boolean = False
    ...
    Private Sub OwnedVehicleDataGridView_RowEnter(sender As Object, e As DataGridViewCellEventArgs) Handles OwnedVehicleDataGridView.RowEnter
        ...
        SelectedVehicleTextBox.Text = OwnedVehicleDataGridView.Item("YearManufactured_ShortText4", CurrentOwnedVehicleDataGridViewRow).Value & " " &
                                       OwnedVehicleDataGridView.Item("VehicleType_ShortText20", CurrentOwnedVehicleDataGridViewRow).Value & " " &
                                       OwnedVehicleDataGridView.Item("VehicleModel_ShortText20", CurrentOwnedVehicleDataGridViewRow).Value & " " &
                                       OwnedVehicleDataGridView.Item("VehicleTrimName_ShortText25", CurrentOwnedVehicleDataGridViewRow).Value
    End Sub
    ...
    Private Sub GetOwnedVehicles()
        ...
        VehicleServicedFieldsToSelect = " Select " &
                         " VehicleServicedTable.VehicleServicedID_AutoNumber, " &
        ...
        VehicleServicedTablesLinks = "FROM(((((VehicleServicedTable LEFT JOIN VehicleDetailsTable ON VehicleServicedTable.VehicleDetailsID_LongInteger = VehicleDetailsTable.VehicleDetailsID_AutoNumber) " &
        ...
        VehicleServicedSelectionFilter = " WHERE OwnerID_LongInteger = " & Str(CurrentOwnerId)


        MySelection = VehicleServicedFieldsToSelect & VehicleServicedTablesLinks & VehicleServicedSelectionFilter & VehicleServicedSelectionOrder
        JustExecuteMySelection()


        VehiclesDbControls.MyDbCommand(MySelection)
        OwnedVehicleDataGridView.DataSource = RecordFinderDbControls.MyAccessDbDataTable
        ...
        If Not PassedThisWayYet Then
            PassedThisWayYet = True
        ...
        If e.RowIndex >= 0 Then
            ...
            If Confirmed Then
                ...
                WorkOrderForm.VehicleDetailsTextBox.Text = Trim(OwnedVehicleDataGridView("YearManufactured_ShortText4", e.RowIndex).Value) & ", " &
                                                                  ...
                                                                  Trim(OwnedVehicleDataGridView("Engine_ShortText20", e.RowIndex).Value)
    ...
    Private Sub AddVehicleToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AddVehicleToolStripMenuItem.Click
        ShowAddVehicleServicedDetails()
    End Sub
    Private Sub ShowAddVehicleServicedDetails()
