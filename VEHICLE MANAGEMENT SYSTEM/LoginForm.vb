...
DepartmentsTable.DepartmentName_ShortText35
 ...
 " &
            UserToFind
                ...
                Dim FirstName = Trim(IIf(IsDBNull(r("FirstName_ShortText15")), "", r("FirstName_ShortText15")))
                Dim LastName = Trim(IIf(IsDBNull(r("LastName_ShortText15")), "", r("LastName_ShortText15")))
