Public Class UsersForm
    ...
    Private Sub FillUserDataGridView()
        ...
        UsersDataGridView.Columns.Item("LastName_ShortText15").HeaderText = "UserDate"
        UsersDataGridView.Columns.Item("LastName_ShortText15").Width = 15 * 184 / 15                            ' 20 for dates with time such as now()

        UsersDataGridView.Columns.Item("FirstName_ShortText15").HeaderText = "CityName"                'note 15 chars = 184 pixels  new pixels = char x 184/15
        UsersDataGridView.Columns.Item("FirstName_ShortText15").Width = 15 * 184 / 15
