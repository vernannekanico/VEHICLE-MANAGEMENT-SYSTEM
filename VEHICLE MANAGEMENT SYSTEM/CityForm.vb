...
Public Class CityForm
    ...
    Private Function AChangeOccured()
        If TheseAreNotEqual(CityTextBox.Text, CityDataGridView.Item("LastName_ShortText15", CurrentCityDataGridViewRow).Value, PurposeOfEntry) Then Return True
        If TheseAreNotEqual(StateProvTextBox.Text, CityDataGridView.Item("FirstName_ShortText15", CurrentCityDataGridViewRow).Value, PurposeOfEntry) Then Return True
