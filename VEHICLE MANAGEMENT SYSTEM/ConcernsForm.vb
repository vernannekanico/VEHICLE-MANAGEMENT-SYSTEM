...
"
        ...
        Else
            ConcernsFieldsToSelect = "SELECT ConcernAsIsByClientTable.LongTextConcernID_Autonumber, ConcernAsIsByClientTable.LongTextConcern_LongText FROM ConcernAsIsByClientTable "
...
FROM ConcernAsIsByClientTable "
    ...
    Public Sub FillConcernsTypeComboBox()
        MySelection = "Select  " &
                          ...
                          " WHERE  InformationsHeadersTypeClass_ShortText100 = " & Chr(34) & "CONCERNS" & Chr(34) &
