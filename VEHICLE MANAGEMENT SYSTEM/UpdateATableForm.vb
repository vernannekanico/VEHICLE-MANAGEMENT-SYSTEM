...
ExtractedWordsDataGridView("ExtractedWordShortText30", CurrentExtractedWordRow).Value
    ...
    Private Sub ExtractedWordTypeDataGridView_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles ExtractedWordTypeDataGridView.CellContentClick
