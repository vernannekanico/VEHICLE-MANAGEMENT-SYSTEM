Public Class UpdateATableForm
    ...
    Private WorkOrderConcernJobID = -1
    Private CurrentlyWorkingOn = ""
    ...
    Private Sub FormatProductsPartsDataGridView()
        ...
        ProductsPartsDataGridView.Columns.Item("ProductsPartID_Autonumber").Visible = False
    ...
    Private Sub FillExtractedWordsDataGridView()
        ...
        ExtractedWordsTablesLinks = " FROM( " &
                      " ExtractedWordsTable " &
                            " LEFT JOIN ProductsPartsTable On ExtractedWordsTable.ProductPartID_LongInteger = ProductsPartsTable.ProductsPartID_Autonumber) " &
        ...
        ExtractedWordsSelectionFilter = " WHERE ProductsPartID_Autonumber = " & CurrentProductsPartID.ToString
    ...
    Private Sub ProductsPartsDataGridView_RowEnter(sender As Object, e As DataGridViewCellEventArgs) Handles ProductsPartsDataGridView.RowEnter
        ...
        If CurrentlyWorkingOn = "VehicleInformationsTable" Then Exit Sub
        CurrentProductsPartsRow = e.RowIndex
        CurrentProductsPartID = ProductsPartsDataGridView.Item("ProductsPartID_Autonumber", CurrentProductsPartsRow).Value
    ...
    Private Sub UpdateProductsPartsTable(PassedField, PassedValue)
        ...
        Select Case PassedField
            ...
            Case 4 'ProductDescriptionFormatted
                ...
                tmpProductsPartsFilter = " WHERE ProductsPartID_Autonumber = " & CurrentProductsPartID.ToString
...
ExtractedWordsDataGridView("ExtractedWordShortText30", CurrentExtractedWordRow).Value
    ...
    Private Sub ProcessVehicleToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles ProcessVehicleToolStripMenuItem.Click
        ExtractedWordTypeComboBox.Visible = True
    ...
    Private Sub SelectCustomerToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles SelectCustomerToolStripMenuItem.Click
        ...
        For EachCurrentProductPartRecord = 0 To RowCount - 1
            ...
            If PageDisplayCounter > 100 Then
                ...
                MsgBox("pause")
            End If
            CurrentProductsPartID = ProductsPartsDataGridView("ProductsPartID_Autonumber", EachCurrentProductPartRecord).Value
    ...
    Private Sub RePhraseAllToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles RePhraseAllToolStripMenuItem.Click
        ...
        For EachProductPartRecord = 0 To ProductsPartsRecordCount - 1
            CurrentProductsPartID = ProductsPartsDataGridView.Item("ProductsPartID_Autonumber", EachProductPartRecord).Value
            FillExtractedWordsDataGridView()
    ...
    Private Sub AddANewWordToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AddANewWordToolStripMenuItem.Click
        MenuStrip2.Enabled = False
        AddANewWordGroupBox.Visible = True
    End Sub


    Private Sub JoinWordsToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles JoinWordsToolStripMenuItem.Click
        MenuStrip2.Enabled = False
        ProductsPartsDataGridView.Enabled = False
    ...
    Private Sub FinalizeToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles FinalizeToolStripMenuItem.Click
    ...
    Private Sub ToolStripMenuItem2_Click(sender As Object, e As EventArgs) Handles ToolStripMenuItem2.Click
        MsgBox("This can be run several times")
        Dim CurrentInformationsHeaderID = -1

        MySelection =
            "
SELECT WorkOrderConcernJobsTable.InformationsHeaderID_LongInteger, 
...
FROM WorkOrderConcernJobsTable LEFT JOIN WorkOrderConcernsTable ON WorkOrderConcernJobsTable.WorkOrderConcernID_LongInteger = WorkOrderConcernsTable.WorkOrderConcernID_AutoNumber 
WHERE WorkOrderConcernsTable.WorkOrderID_LongInteger IS NOT NULL "
        JustExecuteMySelection()
        ...
        For WorkOrderConcernJobsIndex = 0 To RecordCount - 1
            ...
            UpdateVehicleInfornmationsTable(CurrentInformationsHeaderID)
        Next

    End Sub
    Private Sub UpdateVehicleInfornmationsTable(CurrentInformationsHeaderID)
        Dim xxVehicleInformationId = -1
        MySelection = " SELECT top 1 * FROM VehicleInformationsTable " &
                        " WHERE InformationsHeaderID_LongInteger = " & CurrentInformationsHeaderID.ToString &
                        " AND VehicleID_LongInteger = " & CurrentVehicleID.ToString
        JustExecuteMySelection()
        If RecordCount > 0 Then
            Dim r = RecordFinderDbControls.MyAccessDbDataTable.Rows(0)
            xxVehicleInformationId = r("VehicleInformationID_AutoNumber")
            GoTo UpdateWorkOrderConcernTable
        End If
        Dim FieldsToUpdate = "InformationsHeaderID_LongInteger, VehicleID_LongInteger "
        Dim FieldsData = CurrentInformationsHeaderID.ToString & ", " & CurrentVehicleID.ToString
        xxVehicleInformationId = InsertNewRecord("VehicleInformationsTable", FieldsToUpdate, FieldsData)
UpdateWorkOrderConcernTable:
        Dim RecordFilter = " WHERE WorkOrderConcernJobID_AutoNumber = " & WorkOrderConcernJobID.ToString
        Dim SetCommand = " SET VehicleInformationID_LongInteger = " & xxVehicleInformationId.ToString
