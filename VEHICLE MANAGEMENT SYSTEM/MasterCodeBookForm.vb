...
Public Class MasterCodeBookForm
    ...
    Private Sub FillSystemInfoHeadersDataGridView()
        ...
        SystemInfoHeadersTablesLinks = " FROM((SystemInfoHeadersTable LEFT JOIN MasterCodeBookTable On SystemInfoHeadersTable.MasterCodeBookId_LongInteger = MasterCodeBookTable.MasterCodeBookID_Autonumber) " &
                                          ...
                                          " Left JOIN InfoPerVehicleTable On SystemInfoHeadersTable.InfoPerVehicleID_LongInteger = InfoPerVehicleTable.InfoPerVehicleID_AutoNumber "
        ...
        If Not SystemInfoHeadersDataGridViewInitialized Then
            ...
            SystemInfoHeadersDataGridView.Columns.Item("FileName_ShortText255").Visible = False
    ...
    Private Sub SystemInfoHeadersTableDataGridView_RowEnter(sender As Object, e As DataGridViewCellEventArgs) Handles SystemInfoHeadersDataGridView.RowEnter
        ...
        CurrentInformationHeaderID = SystemInfoHeadersDataGridView("InformationsHeaderID_LongInteger", CurrentSystemInfoHeaderRow).Value
        If DefaultVehicleModelTextBox.Text = "Set Default Vehicle" Then
        ...
        If IsNotEmpty(SystemInfoHeadersDataGridView.Item("FileName_ShortText255", CurrentSystemInfoHeaderRow).Value) Then
            FileName = SystemInfoHeadersDataGridView.Item("FileName_ShortText255", CurrentSystemInfoHeaderRow).Value
    ...
    Private Sub MasterCodeBookForm_EnabledChanged(sender As Object, e As EventArgs) Handles Me.EnabledChanged
        ...
        Select Case Tunnel1
            ...
            Case "Tunnel2InformationsHeadersForm"
                ...
                Dim SystemInfoHeadersSelectionFilter2 = " InfoPerVehicleID_LongInteger = " & CurrentVehicleRepairClassID.ToString
    ...
    Private Sub InsertANewInfoPerVehicleTable()
        ...
        r = RecordFinderDbControls.MyAccessDbDataTable.Rows(0)
        Dim currentInfoPerVehicleID = r("InfoPerVehicleID_AutoNumber")

        MySelection = " UPDATE SystemInfoHeadersTable  Set InfoPerVehicleID_LongInteger  = " & currentInfoPerVehicleID.ToString
        JustExecuteMySelection()
