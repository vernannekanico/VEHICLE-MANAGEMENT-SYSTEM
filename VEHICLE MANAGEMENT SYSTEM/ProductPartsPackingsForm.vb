...
"
        ...
        Dim NoOfHeaderLines = 1, RecordsToDisplay = 20
        SetGroupBoxHeight(NoOfHeaderLines, RecordsToDisplay, ProductPartsPackingsRecordCount, ProductPartsPackingsGroupBox, ProductPartsPackingsDataGridView)
    ...
    Private Function AChangeInProductPartsPackingsOccured()
        ...
        If ProductPartsPackingsRecordCount < 1 Then
            Return True
        End If
