Public Class PersonnelsForm
    ...
    Private Sub PersonnelForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Select Case CurrentUserGroup
            Case "Assistant Service Manager"
                PersonnelSelectionFilter = "   WHERE SystemAccessLevel_ShortText2 = " & Chr(34) & "3C" & Chr(34) 'Lead Service Specialists
                SelectToolStripMenuItem.Visible = True
            Case "Lead Service Specialist"
                PersonnelSelectionFilter = "   WHERE instr(" & Chr(34) & "3D" & Chr(34) & ", SystemAccessLevel_ShortText2) > 0 "
                SelectToolStripMenuItem.Visible = True
    ...
    Private Sub FillPersonnelDataGridView()
        ...
        PersonnelSelectionOrder = " ORDER BY SystemAccessLevel_ShortText2, FirstName_ShortText15 "
        ...
        PersonnelDataGridView.Columns.Item("LastName_ShortText15").HeaderText = "Last Name"
        PersonnelDataGridView.Columns.Item("LastName_ShortText15").Width = 15 * 184 / 15

        PersonnelDataGridView.Columns.Item("FirstName_ShortText15").HeaderText = "First Name"
        PersonnelDataGridView.Columns.Item("FirstName_ShortText15").Width = 15 * 184 / 15
    ...
    Private Sub ShowDetailsGroupBox()
        ...
        Else
            LastNameTextBox.Text = PersonnelDataGridView.Item("LastName_ShortText15", CurrentPersonnelRow).Value
            FirstNameTextBox.Text = PersonnelDataGridView.Item("FirstName_ShortText15", CurrentPersonnelRow).Value
        ...
        Select Case PurposeOfEntry
            ...
            Case "EDIT"
                ...
                PersonnelFieldsToSelect = " UPDATE PersonnelTable  SET " &
                    " LastName_ShortText15 = " & Chr(34) & LastNameTextBox.Text & Chr(34) & ", " &
    ...
    Private Function ThisPersonnelAlreadyExist()
        MySelection = "SELECT * FROM PersonnelTable " &
            " WHERE trim(LastName_ShortText15) = " & Chr(34) & Trim(LastNameTextBox.Text) & Chr(34) &
            " And trim(FirstName_ShortText15) = " & Chr(34) & Trim(FirstNameTextBox.Text) & Chr(34) &
