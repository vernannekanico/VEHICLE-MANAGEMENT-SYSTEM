Public Class VehiclesServicedForm
    ...
    Private Sub FillVehiclesServicedDataGridView()
        ...
        VehiclesServicedDataGridView.Columns.Item("LastName_ShortText30").HeaderText = "Last Name"
        VehiclesServicedDataGridView.Columns.Item("LastName_ShortText30").Width = 120
        VehiclesServicedDataGridView.Width = VehiclesServicedDataGridView.Width + VehiclesServicedDataGridView.Columns.Item("LastName_ShortText30").Width


        VehiclesServicedDataGridView.Columns.Item("FirstName_ShortText30").HeaderText = "First Name"
        VehiclesServicedDataGridView.Columns.Item("FirstName_ShortText30").Width = 120
        VehiclesServicedDataGridView.Width = VehiclesServicedDataGridView.Width + VehiclesServicedDataGridView.Columns.Item("FirstName_ShortText30").Width
