Public Class ProductsPartsForm
    ...
    Private Sub SetToStocksViewMode()
        ...
        VehicleFilterToolStripTextBox.Visible = False   'Working only with stocks
    End Sub
    ...
    Private Sub SetToProductsViewMode()
        ...
        VehicleFilterToolStripTextBox.Visible = True    ''Working with maybe specific products
        ...
        If IsNotEmpty(VehicleFilterToolStripTextBox.Text) Then
            ToggleVehiclefilterToolStripMenuItem.Text = "Remove Vehicle Filter"
        Else
            ToggleVehiclefilterToolStripMenuItem.Text = "Turn On Vehicle Filter to : " & VehicleFilterToolStripTextBox.Text
        End If
        ...
        For i = 0 To ProductsPartsDataGridView.Columns.GetColumnCount(0) - 1
            ...
            Select Case ProductsPartsDataGridView.Columns.Item(i).Name
                ...
                Case "SystemDesc_ShortText100Fld"
                    ...
                    ProductsPartsDataGridView.Columns.Item(i).Visible = True
                Case "PartSpecifications_ShortText30"
