Public Class PartsSpecificationsForm
    ...
    Private Sub PartSpecificationsForm_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If PartSpecificationsTextBox.Enabled Then
            ...
            CodeVehiclePartsSpecificationsGroupBox.Text = "Fluid Specs for " + GetFieldValue("MasterCodeBookTable", "MasterCodeBookID_Autonumber", CurrentMasterCodeBookID, "SystemDesc_ShortText100Fld")
            ...
            PartsSpecificationsGroupBox.Text = "All Fluid Specs for " + GetFieldValue("MasterCodeBookTable", "MasterCodeBookID_Autonumber", CurrentMasterCodeBookID, "SystemDesc_ShortText100Fld")
...
PartsSpecificationsTable.PartsSpecifications_ShortText255, 
...
"
    ...
    Private Sub CodeVehiclePartsSpecificationsDataGridView_RowEnter(sender As Object, e As DataGridViewCellEventArgs) Handles CodeVehiclePartsSpecificationsDataGridView.RowEnter
        PartSpecificationsItemToolStripMenuItem.Visible = False
        AddPartsSpecificationsToolStripMenuItem.Visible = False
        SelectPartsSpecificationsToolStripMenuItem.Visible = False
        EditPartsSpecificationsToolStripMenuItem.Visible = False
        RemovePartsSpecificationsToolStripMenuItem.Visible = False
        If e.RowIndex < 0 Then Exit Sub
        If CodeVehiclePartsSpecificationsRecordCount = 0 Then Exit Sub

        PartSpecificationsItemToolStripMenuItem.Visible = True
        AddPartsSpecificationsToolStripMenuItem.Visible = True
        SelectPartsSpecificationsToolStripMenuItem.Visible = True
        EditPartsSpecificationsToolStripMenuItem.Visible = True
        RemovePartsSpecificationsToolStripMenuItem.Visible = True
...
"
        ...
        MsgBox("I made a stop here to check if PartsSpecificationsTable.MasterCodeBookID_LongInteger" & vbCrLf &
               "The MasterCodeBookID_LongInteger is redundant in the ProductsPartsTable" & vbCrLf &
               "Otherwise DELETE THIS FIELD in the PartsSpecificationsTable")
    ...
    Private Sub PartsSpecificationsDataGridView_RowEnter(sender As Object, e As DataGridViewCellEventArgs) Handles PartsSpecificationsDataGridView.RowEnter
        ...
        If PartSpecificationsTextBox.Text = "type new specifications" Then PartSpecificationsTextBox.Text = ""
        EnableFluidOPtions()
    End Sub
...
"
    ...
    Private Sub RegisterPartsSpecificationsChanges()
        ...
        MySelection = " SELECT * FROM PartsSpecificationsTable WHERE PartsSpecifications_ShortText255 = " & InQuotes(PartSpecificationsTextBox.Text)
        JustExecuteMySelection()
    ...
    Private Sub InsertNewPartsSpecification()
        ...
        Dim FieldsToUpdate = "  MasterCodeBookID_LongInteger, " &
                             "  PartsSpecifications_ShortText255 "
    ...
    Private Sub UpdateQuantitySpecifications()
        ...
        Dim SetCommand = " SET CodeVehicleID_LongInteger = " & CurrentCodeVehicleID.ToString & "," &
                          "PartSpecifications_ShortText255 = " & InQuotes(PartSpecificationsTextBox.Text)
        UpdateTable("PartsSpecificationID_AutoNumbersTable", SetCommand, RecordFilter)
    End Sub
    Private Sub SelectPartsSpecificationsToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SelectPartsSpecificationsToolStripMenuItem.Click
    ...
    Private Sub AddPartsSpecificationsToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AddPartsSpecificationsToolStripMenuItem.Click
    ...
    Private Sub EditPartsSpecificationsToolStripMenuItem_Click_2(sender As Object, e As EventArgs) Handles EditPartsSpecificationsToolStripMenuItem.Click

    End Sub

    Private Sub RemoveFluidPartsSpecificationsToolStripMenuItem_Click_1(sender As Object, e As EventArgs) Handles RemovePartsSpecificationsToolStripMenuItem.Click
