...
Public Class CityForm
    ...
    Private Sub AddToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AddToolStripMenuItem.Click
        ...
        If NotEmpty(SearchCityTextBox.Text) And RecordCount = 0 Then
            CityDetailsForm.CityTextBox.Text = SearchCityTextBox.Text
...
ResetActionTaken:
    ...
    Private Sub ToolStripTextBoxSearch_ReadOnlyChanged(sender As Object, e As EventArgs) Handles SearchCityTextBox.ReadOnlyChanged
    End Sub
